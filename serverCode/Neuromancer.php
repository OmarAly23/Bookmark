...
<html>
    ...
    <body>
            ...
            <div class="container">
                ...
                <div class="book read">
                    <div class="cover">
                    <img src="../bookImages/Neuromancer.jpeg">
                    </div>
                    <div class="description">
                    <p class="title">Neuromancer<br>
                        <span class="author">William Gibson</span></p>
                    </div>
                </div>
                </div>
            </div>
            ...
            <form method="POST" action="Neuromancer.php">
...
<?php
   ...
   $sql = "INSERT INTO `Reviews` (bookName, Reviewer, Review) VALUES ('Neuromancer', '$tmp', '$review')";
