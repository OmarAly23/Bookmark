...
<html>
    <head>
        <title>The Kingkiller Chronicles</title>
    ...
    <body>
            ...
            <div class="container">
                ...
                <div class="book read">
                    <div class="cover">
                    <img src="../bookImages/NameOfTheWind.jpeg">
                    </div>
                    <div class="description">
                    <p class="title">The Kingkiller Chronicles<br>
                        <span class="author">Patrick Rothfuss</span></p>
                    </div>
                </div>
                </div>
            </div>
            ...
            <form method="POST" action="kingKiller.php">
...
<?php
   ...
   $sql = "INSERT INTO `Reviews` (bookName, Reviewer, Review) VALUES ('The Kingkiller Chronicles', '$tmp', '$review')";
