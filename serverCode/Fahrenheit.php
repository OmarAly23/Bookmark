...
<html>
    ...
    <body>
            ...
            <div class="container">
                ...
                <div class="book read">
                    <div class="cover">
                    <img src="../bookImages/fahrenheit.jpeg">
                    </div>
                    <div class="description">
                    <p class="title">Fahrenheit 451</p>
                        <span class="author">Ray Bradbury</span></p>
                    </div>
                </div>
                </div>
            </div>
            ...
            <form method="POST" action="Fahrenheit.php">
...
<?php
   ...
   $sql = "INSERT INTO `Reviews` (bookName, Reviewer, Review) VALUES ('Fahrenheit 451', '$tmp', '$review')";
